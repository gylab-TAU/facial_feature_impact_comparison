...
from modelling.triplet_loss_trainer import TripletLossTrainer


class TripletTrainerFactory(object):
    ...
    def get_trainer(self,
        ...
        if criterion_name.lower() == 'triplet':
            distance_metric = 'l2'
            if 'distance' in criterion_params:
                distance_metric = criterion_params['distance'].lower()
